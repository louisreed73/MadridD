...
export class InfoComponent implements OnInit, OnDestroy {
     ...
     documentosInfo$=this.infoServ.documentosInfoTotalLength$
     .pipe(
          shareReplay(1)
     );
     documentosAcumInfo$=this.infoServ.documentosInfoAcumLength$
     .pipe(
          shareReplay(1)
     );
     resolucionesInfo$=this.infoServ.resolucionesInfoTotalLength$
     .pipe(
          tap(console.log),
          shareReplay(1)
     );
     resolucionesAcumInfo$=this.infoServ.resolucionesInfoAcumLength$
     .pipe(
          tap(console.log),
          shareReplay(1)
     );
     escritosInfo$=this.infoServ.escritosInfoTotalLength$
     .pipe(
          tap(console.log),
          shareReplay(1)
     );
     escritosAcumInfo$=this.infoServ.escritosInfoAcumLength$
     .pipe(
          tap(console.log),
          shareReplay(1)
     );
